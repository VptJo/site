<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"E:\web\site/application/admin\view\goods\add.html";i:1495866896;s:44:"E:\web\site/application/admin\view\base.html";i:1495860029;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<div class="layui-body">
	...
	<div class="layui-tab layui-tab-brief">
		<ul class="layui-tab-title">
			...
			<li class="layui-this">添加物料</li>
		</ul>
		<div class="layui-tab-content">
			<div class="layui-tab-item layui-show">
				<form class="layui-form form-container" action="<?php echo url('admin/goods/add'); ?>" method="post">
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<select name="cate_id" lay-verify="required">
								...
								<option value="<?php echo $vo['id']; ?>"><?php if($vo['level'] != '1'): ?>| <?php for($i=1;$i
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="money" placeholder="请输入费用" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">

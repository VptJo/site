<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"E:\web\site/application/admin\view\menu\index.html";i:1495866897;s:44:"E:\web\site/application/admin\view\base.html";i:1495860029;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
            ...
            <div class="layui-tab-item layui-show">
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo url('admin/menu/add',['pid'=>$vo['id']]); ?>" class="layui-btn layui-btn-small">添加子菜单</a>
                            <a href="<?php echo url('admin/menu/update',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-small">编辑</a>
                            <a href="<?php echo url('admin/menu/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-small ajax-delete">删除</a>
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>

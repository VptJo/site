<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:51:"E:\web\site/application/admin\view\login\index.html";i:1495856712;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<form class="layui-form login-form" action="<?php echo url('admin/login/login'); ?>" method="post">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="login_name" required lay-verify="required" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">密码</label>
        <div class="layui-input-block">
            <input type="password" name="login_pwd" required lay-verify="required" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">

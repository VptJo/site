<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"E:\web\site/application/admin\view\replys\artist.html";i:1495866897;s:44:"E:\web\site/application/admin\view\base.html";i:1495860029;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<div class="layui-body">
	...
	<div class="layui-tab layui-tab-brief">
		<ul class="layui-tab-title">
			<li class="layui-this">艺人评论审核</li>
		</ul>
		<div class="layui-tab-content">
			<div class="layui-tab-item layui-show">

				<form class="layui-form layui-form-pane" action="<?php echo url('admin/replys/artist'); ?>" method="get">
				...
				<table class="layui-table">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="<?php echo url('admin/replys/artist_audit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-small ajax-do">通过</a>
								<a href="<?php echo url('admin/replys/artist_del',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-small ajax-delete">删除</a>
							</td>
						</tr>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</tbody>
...
<script>
	var GV = {
		current_controller: "admin/<?php echo $controller; ?>/artist"
	};
</script>

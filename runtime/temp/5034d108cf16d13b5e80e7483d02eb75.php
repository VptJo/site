<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"E:\web\site/application/admin\view\area\index.html";i:1495866896;s:44:"E:\web\site/application/admin\view\base.html";i:1495860029;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<div class="layui-body">
	...
	<div class="layui-tab layui-tab-brief">
		<ul class="layui-tab-title">
			...
			<li class="">
				<a href="<?php echo url('admin/area/add'); ?>">添加场地</a>
			</li>
		</ul>
		<div class="layui-tab-content">
			<div class="layui-tab-item layui-show">

				<form class="layui-form layui-form-pane" action="<?php echo url('admin/area/index'); ?>" method="get">
				...
				<table class="layui-table">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="<?php echo url('admin/area/update',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-small">编辑</a>
								<a href="<?php echo url('admin/area/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-small ajax-delete">删除</a>
							</td>
						</tr>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</tbody>
